...
> the name in row 49 is Ki-Adi_Mundi, the formula is separating names at the first "-", therefore the name is separated into Ki and Adi, and the Mundi is dropped
...
some_dates <- c(08111997, 11141995, 10011993)
...
pau_hooks <- gasol_hookshots %>%
  count(month_new) # gives count of shots per month
